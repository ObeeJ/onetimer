      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <Card className="rounded-xl hover:shadow-lg transition-shadow cursor-pointer group">
            ...
            <CardContent className="pt-0">
              ...
              <Link href="/filler" className="block">
                <Button className="w-full bg-[#013e5c] hover:bg-[#012a47]">
                  Enter as Filler
                </Button>
              </Link>
            </CardContent>
          ...
          <Card className="rounded-xl hover:shadow-lg transition-shadow cursor-pointer group">
            ...
            <CardContent className="pt-0">
              ...
              <Link href="/creator" className="block">
                <Button className="w-full bg-[#c0694b] hover:bg-[#a85a40]">
                  Enter as Creator
                </Button>
              </Link>
            </CardContent>
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex justify-center gap-4">
            <Button variant="outline" className="border-[#013e5c] text-[#013e5c] hover:bg-[#013e5c] hover:text-white">
              How it Works
            </Button>
            <Button variant="outline" className="border-[#013e5c] text-[#013e5c] hover:bg-[#013e5c] hover:text-white">
              Contact Support
